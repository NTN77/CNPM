...
CREATE DATABASE IF NOT EXISTS `handmadestore` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `handmadestore`;
...
-- Dumping data for table handmadestore.image: ~537 rows (approximately)
...
INSERT INTO `inventory` (`productId`, `quantity`, `costPrice`, `soldOut`, `createDate`, `costPriceUpdate`) VALUES
	...
	(3, 24, 50000.00, 1, '2025-03-10 13:26:15', 40000.00),
	(4, 15, 24000.00, 0, '2024-06-29 07:16:10', 24000.00),
	(5, 5, 24000.00, 1, '2025-03-10 13:26:15', 24000.00),
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `consigneePhoneNumber` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table handmadestore.order: ~15 rows (approximately)
INSERT INTO `order` (`id`, `totalPrice`, `orderDate`, `status`, `consigneeName`, `consigneePhoneNumber`, `address`, `shippingFee`, `userId`, `note`) VALUES
	...
	(15, 139000.00, '2025-03-10 00:00:00', 0, 'Lê Bá Phụng', '0336677141', 'ávx, Xã Bản Lầu, Huyện Mường Khương, Lào Cai', 30000.00, 4, NULL);
...
CREATE TABLE IF NOT EXISTS `order_details` (
  ...
  `explainPriceDifference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table handmadestore.order_details: ~30 rows (approximately)
INSERT INTO `order_details` (`orderId`, `productId`, `quantity`, `sellingPrice`, `finalSellingPrice`, `explainPriceDifference`) VALUES
	...
	(15, 3, 1, 70000.00, 70000.00, NULL),
	(15, 5, 1, 39000.00, 39000.00, NULL);
...
-- Dumping data for table handmadestore.product: ~231 rows (approximately)
INSERT INTO `product` (`id`, `name`, `description`, `sellingPrice`, `stock`, `categoryId`, `discountId`, `isSale`) VALUES
	(1, 'Thiệp handmade vintage Beauty & the White', 'Kích thước lớn hơn thông thường: 11x18cm, gồm bì thư, giấy viết thông điệp và thiệp;\nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11;\nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng;\nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường;\nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,,\nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 70000.00, 11, 2, 0, 1),
	(2, 'Thiệp handmade Film de Paris', 'Mẫu thiệp chúc mừng FILM de PARIS đậm chất retro, vintage hoài cổ;\nKích thước lớn hơn thông thường: 11x18cm, gồm bì thư, giấy viết thông điệp và thiệp;\nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11;\nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng;\nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường;\nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,,\nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 70000.00, 21, 2, NULL, 2),
	(3, 'Thiệp chúc mừng Sweet Mint', 'Mẫu thiệp SWEET MINT - ngọt ngào như viên kẹo bạc hà! \nKích thước lớn hơn thông thường: 11x18cm, gồm bì thư, giấy viết thông điệp và thiệp; \nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11; \nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng; \nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường; \nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,, \nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 70000.00, 23, 2, 6, 1),
	(4, 'Thiệp chúc mừng Black & White', 'Trắng - đen luôn có nét đẹp riêng, mẫu thiệp mang đậm phong cách vintage, hoài cổ & màu sắc tối giản nhưng cá tính với nền là giấy kraft cứng đen kết hợp die cut được sắp xếp hài hòa,\nKích thước: 11x14cm,\nGồm bì thư, giấy viết thông điệp và thiệp,\nThiệp được làm handmade tỉ mỉ, chỉn chu,\nThiệp phù hợp với nhiều dịp tặng 14/2 Valentine, 8/3, 20/10, 20/11, Noel Giáng Sinh,,,', 39000.00, 15, 2, NULL, 0),
	(5, 'Thiệp handmade Amazing Carto', 'Mẫu thiệp AMAZING CARTON cảm hứng từ những tấm bìa cứng thô ráp! \nKích thước: 9x14cm; \nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11; \nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng; \nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường; \nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,, \nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 39000.00, 4, 2, 0, 1),
	(6, 'Thiệp handmade lớn Beauty & the White', 'Kích thước 11x18cm \nChất liệu giấy mỹ thuật cao cấp \nChủ đề đa dạng, tùy biến \nPhù hợp với hầu hết các đối tượng, các dịp như 8/3, 20/10, 20/11, sinh nhật, chúc mừng,,,', 70000.00, 13, 2, 1, 1),
	(7, 'Thiệp da bò độc đáo', 'Kích thước: 10x13,5cm \n\n- Chất liệu da bò chọn lọc, charm đồng, giấy dó \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 50000.00, 17, 2, NULL, 1),
	(8, 'Thiệp dấu sáp mini', 'Thiệp mini đơn giản nhưng đẹp! \n\nThiệp làm & đóng sáp thủ công handmade; \n\nKích thước 6x9cm, gồm giấy viết thông điệp bên trong thiệp; \n\nVật liệu: giấy craft, sáp đóng dấu, dây thừng, giấy mỹ thuật', 19000.00, 40, 2, NULL, 1),
	(9, 'Thiệp handmade Vintage Film', 'Kích thước: 10x14,5cm \n\n- Chất liệu giấy mỹ thuật đặc biệt, charm đồng \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 50, 2, NULL, 1),
	(10, 'Thiệp handmade vintage vải bố', '- Kích thước: 10x14,5cm \n\n- Chất liệu vải bố nâu, charm đồng, giấy dó \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 34, 2, NULL, 1),
	(11, 'Thiệp gỗ Jigsaws', 'Khắc thông điệp theo ý riêng \n\n- Kích thước: 10x14,5cm \n\n- Chất liệu gỗ polywood \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 49, 2, NULL, 0),
	(12, 'Thiệp gỗ Other Half', '- Kích thước: 10x14,5cm \n\n- Chất liệu gỗ polywood \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/10, 8/3, valentine 14/2, giáng sinh, annivesary,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 39, 2, NULL, 1),
	(13, 'Thiệp chúc mừng handmade Blue Pastel', '- Kích thước: 10x14,5cm \n\n- Chất liệu giấy mỹ thuật đặc biệt, charm đồng \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 37, 2, NULL, 1),
	(14, 'Thiệp vintage Retro Clock', '- Kích thước: 10x14,5cm \n\n- Chất liệu giấy mỹ thuật đặc biệt, charm đồng \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 30000.00, 24, 2, NULL, 1),
	(15, 'Thiệp giấy carton handmade - Thiệp chúc mừng sinh nhật', 'Thiệp làm handmade tỉ mỉ lấy cảm hứng từ những tấm carton thô ráp, kết hợp với hoa lá cỏ khô tạo thành mẫu thiệp đẹp, độc đáo, \n\nCó thể thay đổi chủ đề theo yêu cầu, \n\nKích thước: 11x14cm,', 49000.00, 19, 2, NULL, 1),
	(16, 'Thiệp tặng bạn thân - Thiệp vintage retro', 'Thiệp tặng bạn thân - Thiệp vintage retro Là một trong những mẫu thiệp handmade cổ điển, HeadQuarter giúp bạn trở về lại với những giá trị tinh thần mà nhiều khi sống giữa thời đại công nghệ chúng,,,', 49000.00, 11, 2, NULL, 1),
	(17, 'Giấy viết thư cổ điển Vintage', '- Giấy viết thư cổ điển hoa văn vintage Mang dáng dấp cổ điển độc đáo, những tờ giấy viết thư đầy cảm xúc sẽ là của bạn với những thiết kế độc đáo, cổ điển Vintage lạ mắt, Giấy viết thư,,,', 35000.00, 34, 2, NULL, 1),
	(18, 'Khung ảnh đẹp Frame Triple', 'Bộ khung ảnh ba đẹp Bộ ba khung ảnh thiết kế với gỗ mộc mạc, mang phong cách Vintage độc đáo, thiết kế bộ ba, sử dụng trang trí được cả hai mặt tương đương với 6 bức hình, Khung ảnh bộ,,,', 377000.00, 20, 2, NULL, 1),
	(19, 'Khung ảnh frame 6 in 1', 'Khung ảnh frame gỗ trang trí Cực xinh xắn và tiện dụng với bộ khung ảnh frame theo phong cách Vintage ấn tượng: + Bộ sản phẩm tiện dụng với bộ khung gỗ, gắn móc khóa, đồng hồ và khung ảnh kích thước 53,,,', 1337000.00, 10, 2, NULL, 1),
	(20, 'Khung ảnh gỗ 3 in 1', 'Thiết kế cực sang trọng với màu trắng làm chủ đạo, phù hợp với mọi không gian trong căn nhà bạn', 630000.00, 10, 2, NULL, 1),
	(21, 'Khung ảnh, tủ móc khóa, móc treo 3 in 1', 'Kích thước: 21x28cm; \nChất liệu: gỗ;', 347000.00, 0, 2, NULL, 1),
	(22, 'Khung hình vintage triple cỡ lớ', 'Kích thước khung 57x31cm; cỡ hình 10x15cm; trọng lượng 1,38kg; \nChất liệu: gỗ, thiết kế hoài cổ, vintage, cá tính,', 519000.00, 6, 2, NULL, 1),
	(23, 'Khung ảnh handmade - thiệp handmade đẹp 2 in 1', 'Sản phẩm được thiết kế cá tính và đậm chất Vintage cổ xưa sẽ là sản phẩm độc đáo dành cho bạn có nhu cầu lưu giữ những tấm ảnh "hay ho" hay ghi lại khoảnh khắc đáng nhớ, Bạn có thể dán hình hoặc câu chữ yêu thích đặt vào khung hình,', 29000.00, 0, 2, NULL, 0),
	(24, 'Khung ảnh kiểu Địa Trung Hải', 'Mang nắng, gió và biển Địa Trung Hải vào thiết kế không gian của bạn đơn giản chỉ với chiếc khung ảnh này, Kích thước: 19 x 23cm; Chất liệu: gỗ thông đẹp và bền bỉ,', 189000.00, 24, 2, NULL, 1),
	(25, 'Khung ảnh vintage kiểu US Army', 'Bằng chất liệu kim loại, gỗ cùng một chút sáng tạo, khung ảnh US Army sẽ là điểm nhấn cho không gian thêm phần khác lạ, Kích thước khung 1 x 23 x 28cm; cỡ hình 10 x 15cm;', 167000.00, 21, 2, NULL, 1),
	(26, 'Khung ảnh vintage trắng ngà', 'Khung hình thiết kế đơn giản, đẹp, tinh tế, nhẹ nhàng với tông màu trắng, Kích thước lần lượt cho các khổ ảnh 9x9cm giá 105k; 9x13cm giá 162k; 10x15cm giá 173k; 13x18cm giá 197k,', 97000.00, 16, 2, NULL, 1),
	(27, 'Khung ảnh - móc treo FISH HOOK', 'Kích thước: 55x4x20cm; \nChất liệu: gỗ, dây thừng \nKhung 3 ảnh 6x9cm được làm thủ công tỉ mỉ', 379000.00, 0, 2, NULL, 0),
	(28, 'Khung ảnh gỗ và thạch cao Ivory Vintage', 'Khung ảnh gỗ và thạch cao Ivory Vintage ấn tượng Chất liệu gỗ và thạch cao hòa quyện cùng sự sáng tạo độc đáo đã cho ra đời sản phẩm khung ảnh độc đáo Ivory Vintage, Kích thước sản phẩm: 4 x,,,', 349000.00, 5, 2, NULL, 1),
	(29, 'Khung ảnh Hải Âu Mediterranea', 'Chất liệu: gỗ; \nKích thước khung 18x23cm; khổ hình 10x15cm;', 189000.00, 1, 2, NULL, 1),
	(30, 'Khung ảnh Địa Trung Hải Kayak', 'Thiết kế thuyền kayak độc đáo, hiện đại và khác biệt, chiếc khung ảnh Địa Trung Hải này như một chút biến tấu cho không gian của bạn thêm sự mới lạ, Kích thước sản phẩm: 15 x 26cm, được làm bằng chất liệu: gỗ, thừng, thạch cao, sò biển,,,', 167000.00, 0, 2, NULL, 0),
	(31, 'Khung ảnh vintage hoa văn vuông', 'Cổ điển và ấn tượng, chiếc khung ảnh Vintage mang hơi thở hoài cổ nhẹ nhàng và ấn tượng, Chất liệu: gỗ, kích thước khung 18 x 22cm; cỡ hình 10 x 15cm,', 150000.00, 0, 2, NULL, 0),
	(32, 'Khung ảnh mèo Totoro', 'Khung ảnh mèo Totoro Mang nét mộc mạc đơn sơ nhưng cực kì xinh xắn, với khung ảnh mèo Totoro, sự đơn giản từ chiếc khung ảnh có thể làm nổi bật lên tấm hình mà bạn muốn trưng cho không,,,', 84000.00, 3, 2, NULL, 1),
	(33, 'Khung ảnh Staring time (lớn)', 'Khung ảnh gỗ đẹp Staring time Không chỉ là chiếc khung ảnh gỗ, mà nó còn là kỉ vật thời gian gắn bó với rất nhiều người, do đó, một chiếc khung ảnh luôn là món đồ vật được trân trọng,,,,', 212000.00, 2, 2, NULL, 1),
	(34, 'Khung ảnh gỗ thông Rustic', 'Khung ảnh Rustic cỡ lớn Những điều ý nghĩa, những kỷ niệm đẹp hãy lưu lại và trân trọng điều đó bởi đó là những điều sẽ đi suốt cuộc đời của bạn, Chính vì thể hãy giữ cho những bức,,,', 227000.00, 15, 2, NULL, 1),
	(35, 'Khung ảnh Hải Âu Mediterranea', 'Quà tặng khung ảnh Hải Âu Mediterranean Chất liệu: gỗ; Kích thước khung 18x23cm; khổ hình 10x15cm; Like FACEBOOK VIETGIFTCENTER,COM để được cập nhật nhanh nhất!', 189000.00, 13, 2, NULL, 1),
	(36, 'Khung trang trí bàn hoa hồng sứ C-rose frame', 'Phong cách "mộc" ấn tượng cho khung trang trí để bàn C-rose, Ngoài việc trang trí, khung trang trí còn là điểm nhấn phong thủy độc đáo cho nội thất của bạn, Khung trang trí để bàn hoa hồng Kích thước:13,9 x,,,', 317000.00, 18, 2, NULL, 1),
	(37, 'KHUNG ẢNH NGÔI NHÀ CỬA SỔ NÂU (NGANG)', 'KÍCH THƯỚC: 24,5 * 20,5cm \nChất liệu: Gỗ', 240000.00, 4, 2, NULL, 1),
	(38, 'KHUNG ẢNH NGÔI NHÀ XE ĐẠP', 'KÍCH THƯỚC: 19*26,5cm \nChất liệu: Gỗ', 240000.00, 1, 2, NULL, 1),
	(39, 'KHUNG ẢNH VÒNG ĐU QUAY VINTAGE', 'Khung ảnh vòng đu quay vintage 2 \nKích thước: 33 x 18,5 cm \nChất liệu: kim loại', 189000.00, 0, 2, NULL, 0),
	(40, 'Bì thư vintage Tem Việt', 'BÌ THƯ VINTAGE CỔ ĐIỂN Bao thư với phong cách vintage thích hợp cho bạn nếu yêu thích những phong cách retro đặc biệt ấn tượng này, Bạn có thể sử dụng để làm quà tặng hoặc để trang trí đều,,,', 35000.00, 12, 2, NULL, 1),
...
-- Dumping data for table handmadestore.rate: ~10 rows (approximately)
INSERT INTO `rate` (`productId`, `userId`, `starRatings`, `comment`, `createDate`, `changeNumber`, `sentiment`) VALUES
	(1, 1, 4, 'Sản phẩm tốt', '2023-11-29 00:00:00', 0, 'tích cực'),
	(1, 4, 5, 'Sản phẩm chất liệu tốt và rất đẹp', '2023-12-01 00:00:00', 0, 'tích cực'),
	(7, 1, 5, 'Thiếp đẹp mắt và rất phù hợp', '2023-12-03 00:00:00', 0, 'tích cực'),
	(12, 3, 5, 'Sản phẩm quá đẹp rất hợp ý tôi!', '2023-11-29 00:00:00', 0, 'tích cực'),
	(14, 3, 3, 'Sản phẩm ổn không quá xuất sắc!', '2023-12-02 00:00:00', 0, 'tích cực'),
	(118, 3, 5, 'Không có gì để chê sản phẩm này !', '2023-12-03 00:00:00', 0, 'tích cực'),
	(118, 4, 5, 'Khung ảnh đẹp và tốt lắm ! 10điểm cho shop', '2023-12-01 00:00:00', 0, 'tích cực'),
	(118, 9, 5, 'Quá ưng ý với sản phẩm này!', '2023-12-03 00:00:00', 0, 'tích cực'),
	(139, 19, 2, 'Sản phẩm xấu tệ', '2025-06-14 11:19:32', 0, 'tiêu cực'),
	(141, 19, 1, 'Sản phẩm cùi bắp', '2025-06-14 11:20:03', 0, 'tích cực');
...
CREATE TABLE IF NOT EXISTS `role` (
  `id` tinyint NOT NULL DEFAULT '2',
  `name` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'user',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `createDate` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT 'Bình Thường',
...
INSERT INTO `user` (`id`, `name`, `phoneNumber`, `email`, `password`, `createDate`, `status`, `roleId`) VALUES
	...
	(19, 'abc', '0747712817', 'abc@gmail.com', 'rrKikBsUIlgYAVO1KyIBK3CfZtg=', '2025-06-14 02:39:28', 'Bình Thường', 2);
